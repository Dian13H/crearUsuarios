...
read -rp "Ingrese el directorio home (ej. /home/$USERNAME): " HOME_DIR
read -rp "Ingrese el shell por defecto (ej. /bin/bash): " SHELL

if ! grep -q "^$GROUP:" /etc/group; then
    echo "El grupo $GROUP no existe, se creará el grupo"
    groupadd "$GROUP"
fi
